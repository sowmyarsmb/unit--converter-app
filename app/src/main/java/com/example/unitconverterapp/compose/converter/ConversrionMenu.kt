...
fun ConversionMenu(list: List<Conversion>,
    ...
    var textFieldSize by remember { mutableStateOf(Size.Zero) }// To assign the dropdown the same width as text field
    var expanded by remember { mutableStateOf(false) } //Booleaan value we have 2 boolean value expanded and not expaned
    ...
    Column {
        ...
        OutlinedTextField(
            ...
            label = { Text(text = "Conversiontype") },
            trailingIcon = {
                Icon(
