...
import androidx.compose.ui.text.input.KeyboardType as KeyboardType1
...
fun InputBlock(
    ...
    Column(modifier = Modifier.padding(top = 20.dp)) {
        Row() {
            ...
            TextField(
                ...
                keyboardOptions = KeyboardOptions(
                    ...
                    keyboardType = KeyboardType1.Number
                ),
        ...
        OutlinedButton(
            ...
            },//Lamda expression for click event
        ) {
            //Place a Text composable inside the button"s content
            Text(
                text = "Convert",
                fontSize = 36.sp,
